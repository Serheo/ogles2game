...
static inline void logStruct(Matrix3D m)
{
    int i=0;
    NSLog(@"%lf %lf %lf %lf", m[i++], m[i++],m[i++],m[i++]);
    NSLog(@"%lf %lf %lf %lf", m[i++], m[i++],m[i++],m[i++]);
    NSLog(@"%lf %lf %lf %lf", m[i++], m[i++],m[i++],m[i++]);
    NSLog(@"%lf %lf %lf %lf", m[i++], m[i++],m[i++],m[i++]);
}
...
static inline void Matrix3DSetOrtho2DProjection(Matrix3D matrix, GLfloat left, GLfloat right, GLfloat bottom, GLfloat top)
{
    GLfloat near = -1024;
    GLfloat far = 1024;
    matrix[1] = matrix[2] = matrix[3] = matrix[4] = matrix[6] = 0.f;
