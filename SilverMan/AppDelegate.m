...
{
    UIImage *defaultButtonImage = [UIImage imageNamed:@"steelButton"];
    defaultButtonImage = [defaultButtonImage resizableImageWithCapInsets:UIEdgeInsetsMake(10, 20.0, 10, 20.0)];
